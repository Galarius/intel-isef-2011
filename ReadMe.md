...
<img src="placard.png" width=640px;>
...
<img src="0.0.physical.model.png" width=320px;>
<img src="0.1.physical.model.png" width=320px;>
<img src="0.2.physical.model.png" width=320px;>
...
|![1.0](1.0.physical.progress.png)|![1.1](1.1.physical.progress.png)|
|-|-|
|Considering every tracing ray separately…|We find obstacle from which a tracing ray is reflected.|
![1.2](1.2.physical.progress.png)|![1.3](1.3.physical.progress.png)|
...
|![1.4](1.4.physical.progress.png)|![1.5](1.5.physical.progress.png)|
|Recursion continues until energy of the wave falls beyond given value.|The whole picture.|
|![1.6](1.6.physical.progress.png)|![1.7](1.7.physical.progress.png)|
...
|![1.8](1.8.physical.progress.png)|![1.9](1.9.physical.progress.png)|
...
<img src="2.0.delay.png" width=320px;>
...
<img src="3.0.s.b.eq.png" width=320px;>
...
<img src="4.0.rms.png" width=320px;>

Root Mean Square (RMS)

<img src="4.1.rms.png" width=320px;>
...
<img src="6.0.evo.png" width=320px;>
...
| ![](screens/process.1.editor.png) | ![](screens/process.2.wave.propogation.1.png) |
| --- | --- |
| Designing premise using editor | Wave propagation modelling |
| ![](screens/process.2.wave.propogation.2.png) | ![](screens/process.3.wave.paths.png) |
| Wave propagation with reflections | Wave paths |
| ![](screens/process.4.sound.density.png) | ![](screens/editor.png) |
